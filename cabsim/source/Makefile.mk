...
# Common linker flags
LINK_OPTS  = -Wl,-O1 -Wl,--as-needed -Wl,--strip-all -lsndfile -lfftw3 -lfftw3f -lsamplerate
endif
...
# add 'no-undefined'
LINK_FLAGS      = $(LINK_OPTS) -Wl,--no-undefined $(LDFLAGS) -lsndfile -lfftw3 -lfftw3f -lsamplerate
endif
